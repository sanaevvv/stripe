...
const CoursePage = ({
  ...
  // ユーザーのコースアクセス権を確認
  // userData が存在する場合のみクエリを実行、それ以外は 'skip'をConvexに指示
  const userAccess = useQuery(
    ...
    userData
      ...
      : 'skip',
  ) || { hasAccess: false }; // クエリがundefinedを返した場合（例：スキップされた場合）のフォールバック値
              ...
              <>
                <div className="text-center">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <PurchaseButton courseId={resolvedParams.courseId} />
                  </div>
                </div>
              </>
            )}
